...
/**
 * Flicks a razor-sharp leaf, spinning like a throwing star, straight at the crosshair. Small damage (a 20-health
 * mob takes four), but it snaps into its target with a crisp cut and a burst of leaves.
 */
public class SharpLeavesSpell implements Spell {
    private static final float DAMAGE = 5.0f;
    private static final float SPIN = 1.1f;   // radians per tick

    private static final Slicer.Style LEAF = new Slicer.Style() {
        ...
        public void hitEntity(ServerWorld world, PlayerEntity owner, LivingEntity target, Vec3d at, boolean head) {
            ...
            if (owner != null) {
                ...
                world.playSound(null, owner.getX(), owner.getY(), owner.getZ(), SoundEvents.ENTITY_ARROW_HIT_PLAYER, SoundCategory.PLAYERS, 0.35f, 1.6f);
            }
        }
